...
export default function SignupModal({ open, onClose }: SignupModalProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-[100] flex items-center justify-center overflow-y-auto bg-[#132216]/65 p-3 backdrop-blur-sm sm:p-6"
      role="presentation"
      onMouseDown={(event) => {
    ...
    >
      <div
        ...
        className="relative my-auto grid max-h-[94vh] w-full max-w-[1040px] overflow-y-auto rounded-[28px] bg-white shadow-2xl md:grid-cols-[38%_62%]"
      >
        <button
          ref={closeRef}
          type="button"
          ...
          className="absolute right-4 top-4 z-20 flex h-9 w-9 items-center justify-center rounded-full bg-white text-2xl leading-none text-[#346739] shadow-md transition hover:rotate-90"
        >
          ×
        </button>

        <section className="relative lg:flex hidden min-h-[310px] flex-col overflow-hidden bg-[#F0FFF6] px-6 pb-0 pt-8 sm:px-9 sm:pt-10 md:min-h-[680px]">
          <div className="relative z-10">
            ...
            <h2
              id={titleId}
              className="mt-3 max-w-[300px] text-[26px] font-bold leading-tight text-[#294F2E] sm:text-[32px]"
            >
            ...
            <ul className="mt-7 grid gap-4 sm:grid-cols-2 md:grid-cols-1">
          ...
          <div className="relative mx-auto mt-auto hidden h-[270px] w-full max-w-[330px] md:block">
            <Image
            ...
            >
              ...
              <label className="flex cursor-pointer items-start gap-3 py-1 text-xs leading-5 text-[#657568]">
                ...
                <span>
                  ...
                  <a
                    href="#"
                    className="font-semibold text-[#346739] underline"
                  >
                    Terms of Service
                  </a>{" "}
                  and{" "}
